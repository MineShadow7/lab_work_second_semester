...
TEST(TPolynomial, can_create_monomial) {
  ADD_FAILURE();
}

TEST(TPolynomial, can_add_monomials) {
  ADD_FAILURE();
}

TEST(TPolynomial, can_subscract_monomials) {
  ADD_FAILURE();
}

TEST(TPolynomial, can_multiply_monomials) {
  ADD_FAILURE();
}

TEST(TPolynomial, can_divide_monomials) {
  ADD_FAILURE();
}

TEST(TPolynomial, can_find_derivative_monomials) {
  ADD_FAILURE();
}

TEST(TPolynomial, can_compare_monomials) {
  ADD_FAILURE();
}

TEST(TPolynomial, can_assign_monomials) {
  ADD_FAILURE();
}
